...
function AddProductModal({ isOpen, onClose, onAddProduct }) {
  ...
  useEffect(() => {
    // If we have a success message, set up the reload
    if (successMessage) {
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors ${imagePreview ? "border-blue-300" : "border-gray-300"}`}
