          ...
          {currentStep === 1 && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* <div className="space-y-2">
                  <label htmlFor="old_price" className="flex items-center text-sm font-medium text-gray-700">
                    <DollarSign className="w-4 h-4 mr-2 text-indigo-600" />
                    Giá gốc
                  </label>
                  <div className="relative">
                ...
                {/* <div className="space-y-2">
                  <label htmlFor="discount" className="flex items-center text-sm font-medium text-gray-700">
                    <Tag className="w-4 h-4 mr-2 text-indigo-600" />
                    Chiết khấu (%)
                  </label>
                  <input
              ...
              <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* <div className="space-y-2">
                  ...
                  <p className="font-medium line-through text-gray-500">
                    {formData.old_price
                      ? `${Number.parseInt(formData.old_price.toString()).toLocaleString("vi-VN")}₫`
                      : "Không có"}
                  </p>
                </div> */}
                <div className="space-y-2">
                ...
                {/* <div className="space-y-2">
                  ...
                  <p className="font-medium">{formData.discount ? `${formData.discount}%` : "Không có"}</p>
                </div> */}
